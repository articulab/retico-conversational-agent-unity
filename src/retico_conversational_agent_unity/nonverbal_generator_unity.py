...
class NonverbalGeneratorUnityModule(retico_core.abstract.AbstractModule):
    """A Module producing audio action from TextAlignedAudioIUs from TTS."""

    @staticmethod
    def name():
        return "NonverbalGeneratorUnity Module"
    ...
    def __init__(self, **kwargs):
        """
        Initialize the NonverbalGeneratorUnity Module.
        """
